...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #0000;">
      ...
      <footer class="text-center mt-5 py-2" style = "background-color: #0000";>
        <p style = "color: white";> <strong>&copy 2021. Made by <b> Sanket Muchhala </b><br> Sparks Bank <br></strong></p>
      </footer>
